...
const en = {
  ...
  redo: 'Redo',
  celebrate: 'Celebrate!',
  replay: 'Replay how you painted it',
  ...
  toolMarker: 'Marker',
  toolEraser: 'Eraser',
  toolSticker: 'Stickers',
  fillGlitter: 'Glitter fill',
...
const dictionaries: Record<string, Partial<Record<MessageKey, string>>> = {
  ...
  ru: {
    ...
    redo: 'Вернуть',
    celebrate: 'Праздник!',
    replay: 'Показать, как ты рисовал',
  ...
  de: {
    ...
    redo: 'Wiederholen',
    celebrate: 'Feiern!',
    replay: 'Zeig, wie du gemalt hast',
    ...
    themeToggleToDark: 'Dunkles Thema',
    themeToggleToLight: 'Helles Thema',
  },
};
